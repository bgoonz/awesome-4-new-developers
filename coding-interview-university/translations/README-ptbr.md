...
- ### Listas Ligadas
  ...
  - [ ] [C Code (video)](https://www.youtube.com/watch?v=QN6FPiD0Gzo) (Código em C - vídeo) - não o vídeo inteiro, apenas as partes sobre estrutura de nodes (nós) e alocação de memória.
...
- ### Aprendizado de Máquina
  ...
  - Cursos:
    - [Ótimo curso iniciante: Aprendizado de Máquina](https://www.coursera.org/learn/machine-learning) - [somente vídeos](https://www.youtube.com/playlist?list=PLZ9qNFMHZ-A4rycgrgOYma6zxF4BZGGPW) - veja os vídeos 12-18 para uma revisão de algebra linear (14 e 15 são duplicados)
