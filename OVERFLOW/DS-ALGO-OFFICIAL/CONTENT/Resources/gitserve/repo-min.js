...
(function (a) {
  a.fn.repo = function (j) {
    var g = this,
      ...
      f = function (k) {
        return (
          k[0].clientHeight + g.container.find("h1").outerHeight(true) + 15
        );
      },
      e = function (l) {
        var k = {
    ...
    if (
      typeof g.settings.css != "undefined" &&
      g.settings.css !== "" &&
      a("#repojs_css").length <= 0
    ) {
          ...
          if (o.hasClass("file")) {
            ...
            if (n.legnth > 0) {
              ...
              a.ajax({
                ...
                success: function (t) {
                  var s = a(
                      '<div class="file page" id="' + p.data("id") + '"></div>'
                    ),
                  ...
                  if ("image" === u.split("/").shift()) {
                    n = s
                      ...
                      .appendTo(m);
                    n.find("img")
                      .attr("src", "data:" + u + ";base64," + t.data.content)
                      .attr("alt", t.data.name);
                  } else {
            ...
            if (o.hasClass("dir")) {
              ...
              if (o.hasClass("back")) {
                ...
                g.container
                  .find("h1 a")
                  .slice(p.index() + 1, g.container.find("h1 a").length)
                  .remove();
                h(n, "right");
              }
            }
