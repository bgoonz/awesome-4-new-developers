...
describe( 'GraphNode Algorithms', () => {
  describe( 'breadthFirstSearch(startingNode, targetVal)', () => {
    ...
    context( 'when the targetVal is contained in the full graph', () => {
      it( 'should return the GraphNode that has the targetVal', () => {
        l        let b = new GraphNode( 'b' );
        let c = new GraphNode( 'c' );
        a.neighbors = [ b, c ];
        expect(        expect( breadthFirstSearch( a, 'a' ) ).to.equal( a );
      } );
    } );

    contex      it( 'should return the first GraphNode that contains the targetVal according to left-to-right Breadth-First order', () => {
        let a = new GraphNode( 'a' );
        let b = new GraphNode( 'b' );
    ...
    conte      it( 'should not get trapped in an infinite loop', () => {
  ...
  describe( 'maxValue(startingNode)', () => {
    ...
    it( 'should return the largest value within the full graph', () => {
      ...
      let th      let two = new GraphNode( 2 );
