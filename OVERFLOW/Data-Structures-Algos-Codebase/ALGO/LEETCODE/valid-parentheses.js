...
are not.*/
/*Solution Algo - 
A ) If I can match all of the passed - in parenthesis after traversing the string character by character, then
return true.Else,
  if a single unmatched parenthesis remains, then
return false.
