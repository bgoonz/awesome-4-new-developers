...
let CONFIG = {
  ...
  cookie:
    "__cfduid=d49cf8f975443623a42cea16ce958f1d51505577150; LEETCODE_SESSION=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..VISGbiIlFirZxAFBE-hS_WsRTc2bqoOu173RwdXe6RU; _ga=GA1.2.783262919.1488459467; _gid=GA1.2.1984063667.1507463694; csrftoken=ibul4lK9xgp6oErImXb2gf1ZJpGDTwZQku3pn0RQbqBsBL6etp7EuSEcuhBOVP3Q; __atuvc=0%7C37%2C0%7C38%2C5%7C39%2C5%7C40%2C3%7C41; __atuvs=59da2970e14d45b2000",
  // from local
...
function makeMarkdownFile(data) {
  ...
  let tpl = `# Leetcode Solutions with JavaScript [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)
...
`;
  ...
  problems.forEach((item) => {
    ...
    if (isLocked) tpl += ":blue_book: ";

    if (isSolved) {
      let languageArray = [];
      if (languageJS) languageArray.push(`[${languageJS}](${sourceCodeJS})`);
      if (languagePY) languageArray.push(`[${languagePY}](${sourceCodePY})`);
      if (languageCPP) languageArray.push(`[${languageCPP}](${sourceCodeCPP})`);
    ...
    if (explanation) tpl += `| [Explanation](${explanation}) `;
    else {
      tpl += "| ";
    }
          ...
          files.forEach((fileName) => {
            if (fileName.endsWith("md")) {
              ...
              if (fileName.endsWith("js")) {
                ...
                p.sourceCodeJS = encodeURI(
                  baseNetSrc + p.title + "/" + fileName
                );
              } else if (fileName.endsWith("cpp")) {
                p.languageCPP = "C++";
                p.sourceCodeCPP = encodeURI(
                  baseNetSrc + p.title + "/" + fileName
                );
              } else if (fileName.endsWith("py")) {
                p.languagePY = "Python";
                p.sourceCodePY = encodeURI(
                  baseNetSrc + p.title + "/" + fileName
                );
              }
            }
