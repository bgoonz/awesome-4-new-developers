    ...
    if (tool.stackShareData) {
      return (
        <StackShareCard
          ...
          stackshare={tool.stackShareData}
        >
          {tool.description}
        </StackShareCard>
      )
        ...
        <div className="container">
          ...
          <div className="columns">
            <div className="column is-6">
              <Link
                className="button is-medium is-danger has-text-white"
                to={`/#${stack.path}`}
              >
                &lt; Back to stacks
              </Link>
            ...
            <div className="column is-6">
              <div className="has-text-right">
                <a
                  ...
                  href={`${data.site.siteMetadata.repository}/blob/master/README.md#${stack.path}-`}
                >
