...
class BasicTests(ConsistencyTestBase):
    ...
    def testSquare(self):
        ...
        self._generic_test(
            f,
            [
                Example(arg=(3,), out=9.0, failure=[], bugs=[]),
                Example(
                    arg=(tf.constant(3.0),), out=tf.constant(9.0), failure=[], bugs=[]
                ),
            ],
        )
    ...
    """
        ...
        input_args = [3, 3.2, tf.constant(3.0)]
    ...
    def testSkipModes(self):
        ...
        self._generic_test(
            f,
            [Example(arg=(3.0,), out=3.0, failure=[], bugs=[])],
        ...
        self._generic_test(
            ...
            [
                Example(
                    ...
                    out=out_t,
                    failure={
                        RunMode.FUNCTION: "If shallow structure is a sequence, input must also "
                        "be a sequence",
                        RunMode.XLA: "If shallow structure is a sequence, input must also "
                        "be a sequence",
                        RunMode.SAVED: "Found zero restored functions for caller function",
                    },
                    bugs=["b/162452468"],
                )
            ],
