...
class TFAPIChangeSpec(ast_edits.NoUpdateSpec):
    ...
    def __init__(self, import_rename=False, upgrade_compat_v1_import=False):
        ...
        self.function_keyword_renames = {
            ...
            "tf.sparse.reduce_max": {"reduction_axes": "axis", "keep_dims": "keepdims"},
            "tf.sparse_reduce_max": {"reduction_axes": "axis", "keep_dims": "keepdims"},
            "tf.sparse.reduce_sum": {"reduction_axes": "axis", "keep_dims": "keepdims"},
            "tf.sparse_reduce_sum": {"reduction_axes": "axis", "keep_dims": "keepdims"},
