...
def collect_constant_renames():
  ...
  """
    ...
    for module in sys.modules.values():
        ...
        constants_v1 = {
            constant_name: api_names for api_names, constant_name in constants_v1_list
        }
        constants_v2 = {
            constant_name: api_names for api_names, constant_name in constants_v2_list
        }
...
def collect_function_renames():
  ...
  """
    ...
    renames = set(
        (name, new_name) for name, new_name in renames if name not in v2_names
    )
    return renames
...
def update_renames_v2(output_file_path):
  ...
  """
    ...
    manual_renames = set(all_renames_v2.manual_symbol_renames.keys())
