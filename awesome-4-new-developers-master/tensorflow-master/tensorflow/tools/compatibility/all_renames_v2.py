...
manual_symbol_renames = {
    ...
    "tf.contrib.cluster_resolver.KubernetesClusterResolver": "tf.distribute.cluster_resolver.KubernetesClusterResolver",
    "tf.contrib.cluster_resolver.SimpleClusterResolver": "tf.distribute.cluster_resolver.SimpleClusterResolver",
    "tf.contrib.cluster_resolver.SlurmClusterResolver": "tf.distribute.cluster_resolver.SlurmClusterResolver",
    "tf.contrib.cluster_resolver.TFConfigClusterResolver": "tf.distribute.cluster_resolver.TFConfigClusterResolver",
    "tf.contrib.cluster_resolver.TPUClusterResolver": "tf.distribute.cluster_resolver.TPUClusterResolver",
    "tf.contrib.cluster_resolver.UnionClusterResolver": "tf.distribute.cluster_resolver.UnionClusterResolver",
    ...
    "tf.contrib.distribute.ReductionToOneDeviceCrossDeviceOps": "tf.distribute.ReductionToOneDevice",
    ...
    "tf.contrib.framework.nest.assert_same_structure": "tf.nest.assert_same_structure",
    "tf.contrib.framework.nest.flatten": "tf.nest.flatten",
    "tf.contrib.framework.nest.is_sequence": "tf.nest.is_nested",
    ...
    "tf.contrib.saved_model.save_keras_model": "tf.compat.v1.keras.experimental.export_saved_model",
    ...
    "tf.contrib.rnn.static_state_saving_rnn": "tf.compat.v1.nn.static_state_saving_rnn",
    ...
    "tf.contrib.summary.create_file_writer": "tf.compat.v2.summary.create_file_writer",
    ...
    "tf.contrib.tpu.InputPipelineConfig": "tf.compat.v1.estimator.tpu.InputPipelineConfig",
    ...
    "tf.contrib.tpu.TPUEstimatorSpec": "tf.compat.v1.estimator.tpu.TPUEstimatorSpec",
    ...
    "tf.losses.Reduction.SUM_BY_NONZERO_WEIGHTS": "tf.compat.v1.losses.Reduction.SUM_BY_NONZERO_WEIGHTS",
    "tf.losses.Reduction.SUM_OVER_NONZERO_WEIGHTS": "tf.compat.v1.losses.Reduction.SUM_OVER_NONZERO_WEIGHTS",
    ...
    "tf.debugging.assert_greater_equal": "tf.compat.v1.debugging.assert_greater_equal",
    ...
    "tf.debugging.assert_rank_at_least": "tf.compat.v1.debugging.assert_rank_at_least",
    "tf.debugging.assert_rank_in": "tf.compat.v1.debugging.assert_rank_in",
    "tf.errors.exception_type_from_error_code": "tf.compat.v1.errors.exception_type_from_error_code",
    "tf.errors.error_code_from_exception_type": "tf.compat.v1.errors.error_code_from_exception_type",
    "tf.errors.raise_exception_on_not_ok_status": "tf.compat.v1.errors.raise_exception_on_not_ok_status",
    ...
    "tf.keras.initializers.RandomUniform": "tf.compat.v1.keras.initializers.RandomUniform",
    ...
    "tf.keras.initializers.RandomNormal": "tf.compat.v1.keras.initializers.RandomNormal",
    ...
    "tf.data.experimental.map_and_batch_with_legacy_function": "tf.compat.v1.data.experimental.map_and_batch_with_legacy_function",
