...
class DebugEventsWriter(object):
    ...
    def __init__(
        self, dump_root, tfdbg_run_id, circular_buffer_size=DEFAULT_CIRCULAR_BUFFER_SIZE
    ):
    ...
    """
        ...
        _pywrap_debug_events_writer.Init(
            self._dump_root, self._tfdbg_run_id, circular_buffer_size
        )
