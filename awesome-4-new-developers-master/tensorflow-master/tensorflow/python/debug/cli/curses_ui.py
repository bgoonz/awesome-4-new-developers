...
class CursesUI(base_ui.BaseUI):
  ...
  """
    ...
    _KEY_MAP = {127: curses.KEY_BACKSPACE, curses.KEY_DC: 4}  # Backspace  # Delete
    ...
    """
        ...
        if x in self.CLI_CR_KEYS:
            ...
            if not self._active_command_history:
                ...
                self._active_command_history = self._command_history_store.lookup_prefix(
    ...
    """
        ...
        self._curr_wrapped_output, wrapped_line_indices = debugger_cli_common.wrap_rich_text_lines(
            output, self._max_x - 2
        )
