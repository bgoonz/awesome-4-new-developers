...
class DefFunctionTest(test.TestCase, parameterized.TestCase):
            ...
            def compute(self, var_creation_flag):
                ...
                if var_creation_flag not in self._flag_keyed_vars:
                    if var_creation_flag:
                        self._flag_keyed_vars[var_creation_flag] = variables.Variable(
                            1.0
                        )
                    else:
                        self._flag_keyed_vars[var_creation_flag] = variables.Variable(
    ...
    def testInputSignaturePartialFuncMissingTensorSpecs(self, func_type):
        ...
        with self.assertRaisesRegex(TypeError, "TensorSpecs are still required.*arg3"):
        ...
        self.assertAllEqual(
            tf_func_dec(functools.partial(f, 1, 2, arg4=5))(3), array_ops.constant(11)
        )
    ...
    def testFunctionReferenceCycles(self):
        fn = def_function.function(lambda x: 2.0 * x)
    ...
    def testNonUniqueNamesGetConcreteFunction(self):
        ...
        self.assertAllClose(
            ...
            concrete(
                ...
                x_1=constant_op.constant(2.0),
                x_2=constant_op.constant(3.0),
