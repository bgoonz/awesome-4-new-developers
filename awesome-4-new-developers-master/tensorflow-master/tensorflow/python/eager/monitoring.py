...
class Metric(object):
    ...
    """
        ...
        if label_length >= len(self._metric_methods):
            raise ValueError(
                "Cannot create {} metric with label >= {}".format(
    ...
    def get_cell(self, *labels):
        ...
        if len(labels) != self._label_length:
            raise ValueError(
                "The {} expects taking {} labels".format(
  ...
  """
    ...
    """
        super(Counter, self).__init__(
            "Counter", _counter_methods, len(labels), name, description, *labels
        )
...
class IntGauge(Metric):
  ...
  """
    ...
    Args:
      ...
      *labels: The label list of the new metric.
    """
        super(IntGauge, self).__init__(
            "IntGauge", _int_gauge_methods, len(labels), name, description, *labels
        )
...
class StringGauge(Metric):
  ...
  """
    ...
    Args:
      ...
      *labels: The label list of the new metric.
    """
        super(StringGauge, self).__init__(
            "StringGauge",
            _string_gauge_methods,
            len(labels),
            name,
...
class BoolGauge(Metric):
  ...
  """
    ...
    Args:
      ...
      *labels: The label list of the new metric.
    """
        super(BoolGauge, self).__init__(
            "BoolGauge", _bool_gauge_methods, len(labels), name, description, *labels
        )
  ...
  """
    ...
    """
        super(ExponentialBuckets, self).__init__(
            pywrap_tfe.TFE_MonitoringNewExponentialBuckets(
