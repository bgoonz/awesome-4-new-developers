...
class HVPBenchmarks(tf.test.Benchmark):
    ...
    def benchmark_forward_over_backward_hvp_eager(self):
        self._hvp_benchmark(
            _forward_over_back_hvp, "forward_over_backward_hvp_eager", batch_sizes=[8]
        )

    def benchmark_forward_over_backward_hvp_function(self):
        self._hvp_benchmark(
            tf.function(_forward_over_back_hvp),
    ...
    def benchmark_tf_gradients_forward_over_backward_hvp_function(self):
        self._hvp_benchmark(
            tf.function(_tf_gradients_forward_over_back_hvp),
    ...
    def benchmark_backward_over_backward_hvp_eager(self):
        self._hvp_benchmark(
            _back_over_back_hvp, "backward_over_backward_hvp_eager", batch_sizes=[8]
        )

    def benchmark_backward_over_backward_hvp_function(self):
        self._hvp_benchmark(
            tf.function(_back_over_back_hvp),
    ...
    def benchmark_backward_over_forward_hvp_eager(self):
        self._hvp_benchmark(
            _back_over_forward_hvp, "backward_over_forward_hvp_eager", batch_sizes=[8]
        )
