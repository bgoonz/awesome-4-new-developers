...
def hook_dummy_table_variables_to_activations(
    tpu_embedding, activations, dummy_table_variables
):
    ...
    for table_id, table in enumerate(tpu_embedding.table_to_config_dict):
        ...
        for feature, gradient in zip(
            ...
            if gradient is not None:
                ...
                max_sequence_length = tpu_embedding.feature_to_config_dict[
                    feature
                ].max_sequence_length
