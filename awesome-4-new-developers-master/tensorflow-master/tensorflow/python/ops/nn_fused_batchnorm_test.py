...
class BatchNormalizationTest(test.TestCase):
    ...
    def testBatchNormGradGradConfig1(self):
        config = {"shape": [2, 3, 4, 5], "err_tolerance": 1e-2, "dtype": np.float32}
        self._testBatchNormGradGrad(config)

    @test_util.run_deprecated_v1
    def testBatchNormGradGradConfig2(self):
        config = {"shape": [2, 3, 2, 2], "err_tolerance": 1e-3, "dtype": np.float32}
        self._testBatchNormGradGrad(config)

    @test_util.run_deprecated_v1
    def testBatchNormGradGradConfig3(self):
        config = {"shape": [2, 3, 4, 5], "err_tolerance": 2e-2, "dtype": np.float16}
        self._testBatchNormGradGrad(config)

    @test_util.run_deprecated_v1
    def testBatchNormGradGradConfig4(self):
        config = {"shape": [2, 3, 2, 2], "err_tolerance": 2e-3, "dtype": np.float16}
        self._testBatchNormGradGrad(config)

    @test_util.run_deprecated_v1
    def testBatchNormGradGradConfig5(self):
        config = {"shape": [2, 3, 2, 2, 2], "err_tolerance": 2e-3, "dtype": np.float32}
        self._testBatchNormGradGrad(config)

    @test_util.run_deprecated_v1
    def testBatchNormGradGradConfig6(self):
        config = {"shape": [2, 3, 2, 2, 2], "err_tolerance": 3e-3, "dtype": np.float16}
        self._testBatchNormGradGrad(config)
