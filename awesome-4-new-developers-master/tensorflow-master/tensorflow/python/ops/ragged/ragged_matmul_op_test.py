...
class RaggedMatmulOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        [
            ...
            dict(  # Uses matmul_3d_with_map_fn
                ...
                a=lambda: ragged_concat_ops.stack([T([15, 32]), T([10, 20])]),
                b=lambda: ragged_concat_ops.stack([T([32, 19]), T([20, 13])]),
            ...
            dict(  # Uses matmul_3d_with_map_fn
                ...
                a=lambda: T([2, 15, 32]),
                b=lambda: ragged_concat_ops.stack([T([32, 19]), T([32, 13])]),
            ),
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                a=lambda: ragged_concat_ops.stack([T([15, 32]), T([10, 20])]),
                b=lambda: ragged_concat_ops.stack([T([32, 19]), T([22, 13])]),
                exc=errors.InvalidArgumentError,
            ),
            dict(
                a=[[1]],
