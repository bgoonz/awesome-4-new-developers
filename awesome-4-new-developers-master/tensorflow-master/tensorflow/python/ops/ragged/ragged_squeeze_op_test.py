...
class RaggedSqueezeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            {"input_list": [[1]], "squeeze_ranks": [0]},
            {"input_list": [[1]], "squeeze_ranks": [0, 1]},
            {"input_list": [[1, 2]], "squeeze_ranks": [0]},
            {"input_list": [[1], [2]], "squeeze_ranks": [1]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [0]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [1]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [3]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [0, 3]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [0, 1]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [1, 3]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [0, 1, 3]},
            {"input_list": [[[1], [2]], [[3], [4]]], "squeeze_ranks": [2]},
            {"input_list": [[1], [2]], "squeeze_ranks": [-1]},
        ]
    )
    ...
    @parameterized.parameters(
        [
            {"input_list": [[]], "squeeze_ranks": [1]},
            {"input_list": [[1, 2]], "squeeze_ranks": [1]},
            {"input_list": [[1], [2]], "squeeze_ranks": [0]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [0, 2]},
            {"input_list": [[[[12], [11]]]], "squeeze_ranks": [2]},
            {"input_list": [[[1], [2]], [[3], [4]]], "squeeze_ranks": [0]},
            {"input_list": [[[1], [2]], [[3], [4]]], "squeeze_ranks": [1]},
            {"input_list": [[], []], "squeeze_ranks": [1]},
            {"input_list": [[[], []], [[], []]], "squeeze_ranks": [1]},
        ]
    )
