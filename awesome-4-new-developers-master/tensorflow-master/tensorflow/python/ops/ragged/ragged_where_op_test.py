...
class RaggedWhereV1OpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    @parameterized.parameters(
        [
            ...
            # =========================================================================
            dict(  # shape=[D1]
                condition=[True, False, True, False, True], expected=[[0], [2], [4]]
            ),
            dict(  # shape=[D1, D2]
                condition=[[True, False], [False, True]], expected=[[0, 0], [1, 1]]
            ),
            dict(  # shape=[D1, (D2)]
                condition=ragged_factory_ops.constant_value(
                    [[True, False, True], [False, True]]
            ...
            # =========================================================================
            dict(condition=True, x="A", y="a", expected=b"A"),  # shape=[]
            dict(condition=False, x="A", y="a", expected=b"a"),  # shape=[]
            dict(  # shape=[D1]
    ...
    @parameterized.parameters(
        [
            ...
            dict(  # c.shape=[D1, (D2), D3], x.shape=[D1, (D2), 1], y.shape=[D3]
                condition=ragged_factory_ops.constant_value(
                    [[[True, False], [False, True]], [[True, True]]], ragged_rank=1
                ),
                x=ragged_factory_ops.constant_value(
