...
class RaggedConcatOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        ...
        dict(
            ...
            axis=2,
            expected=[
                [[b"a000", b"a001", b"c000"], [b"a010", b"b010", b"b011", b"c010"]],
                [
    ...
    def testStaticError(self, rt_inputs, axis, error, message=None, ragged_ranks=None):
        ...
        self.assertRaisesRegex(
            error, message, ragged_concat_ops.concat, rt_inputs, axis
        )
    ...
    def testNegativeAxisWithUnknownRankError(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            r"axis may only be negative if ndims is statically known.",
            ragged_concat_ops.concat,
            rt_inputs,
            -1,
        )
