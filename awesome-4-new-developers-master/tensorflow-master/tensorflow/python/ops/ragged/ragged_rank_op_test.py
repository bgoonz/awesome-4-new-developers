...
class RaggedRankOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    @parameterized.parameters(
        [
            # Rank 0
            dict(test_input=1, expected_rank=0),
            # Rank 1
            dict(test_input=[1], expected_rank=1),
            dict(test_input=[1, 2, 3, 4], expected_rank=1),
            # Rank 2
            dict(test_input=[[1], [2], [3]], expected_rank=2),
            # Rank 3
            dict(test_input=[[[1], [2, 3]], [[4], [5, 6, 7]]], expected_rank=3),
