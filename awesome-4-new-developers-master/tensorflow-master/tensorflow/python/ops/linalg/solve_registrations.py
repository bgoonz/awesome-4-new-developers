...
def _solve_linear_operator(linop_a, linop_b):
    ...
    return linear_operator_composition.LinearOperatorComposition(
        operators=[linear_operator_inversion.LinearOperatorInversion(linop_a), linop_b],
...
@linear_operator_algebra.RegisterSolve(
    linear_operator_inversion.LinearOperatorInversion, linear_operator.LinearOperator
)
...
def _solve_linear_operator_block_diag_block_diag(linop_a, linop_b):
    return linear_operator_block_diag.LinearOperatorBlockDiag(
        operators=[
            o1.solve(o2) for o1, o2 in zip(linop_a.operators, linop_b.operators)
        ],
        is_non_singular=registrations_util.combined_non_singular_hint(linop_a, linop_b),
