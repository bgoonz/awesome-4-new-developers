...
@linear_operator_algebra.RegisterAdjoint(linear_operator_adjoint.LinearOperatorAdjoint)
...
def _adjoint_block_diag(block_diag_operator):
    ...
    return linear_operator_block_diag.LinearOperatorBlockDiag(
        operators=[operator.adjoint() for operator in block_diag_operator.operators],
...
def _adjoint_kronecker(kronecker_operator):
    ...
    return linear_operator_kronecker.LinearOperatorKronecker(
        operators=[operator.adjoint() for operator in kronecker_operator.operators],
