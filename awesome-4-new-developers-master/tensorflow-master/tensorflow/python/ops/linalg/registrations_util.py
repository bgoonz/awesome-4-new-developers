...
def combined_commuting_self_adjoint_hint(operator_a, operator_b):
    ...
    if (operator_a.is_self_adjoint is True and operator_b.is_self_adjoint is False) or (
        operator_a.is_self_adjoint is False and operator_b.is_self_adjoint is True
    ):
        return False
...
def is_square(operator_a, operator_b):
    ...
    if operator_a.is_square and operator_b.is_square:
        return True
    if (
        operator_a.is_square is False and operator_b.is_square is False
    ):  # pylint:disable=g-bool-id-comparison
...
def combined_commuting_positive_definite_hint(operator_a, operator_b):
    ...
    # pylint:disable=g-bool-id-comparison
    if (
        operator_a.is_positive_definite is True
        and operator_a.is_self_adjoint is True
        and operator_b.is_positive_definite is True
        and operator_b.is_self_adjoint is True
    ):
        return True
    # pylint:enable=g-bool-id-comparison
