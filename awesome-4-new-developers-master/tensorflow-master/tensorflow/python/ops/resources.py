...
_Resource = collections.namedtuple("_Resource", ["handle", "create", "is_initialized"])
...
def report_uninitialized_resources(
    resource_list=None, name="report_uninitialized_resources"
):
