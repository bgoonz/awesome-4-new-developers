...
class ArrayTest(PForTestCase):
    def test_gather(self):
        ...
        def loop_fn(i):
            ...
            for y in [x, x2, x_i]:
                ...
                outputs.append(
                    array_ops.gather(y, [[2, i], [i, 1], [2, 1]], axis=-1, batch_dims=1)
                )
                outputs.append(
    ...
    def test_shape_n(self):
        ...
        def loop_fn(i):
            ...
            return (
                array_ops.shape_n([x_i, x, y, y_i]),
                array_ops.shape_n([x_i, x, y, y_i], out_type=dtypes.int64),
            )
    ...
    def test_broadcast_to(self):
        ...
        def loop_fn(i):
            x1 = array_ops.gather(x, i)
            return (
                array_ops.broadcast_to(x1, [2, 2, 3]),
    ...
    def test_one_hot(self):
        ...
        def loop_fn(i):
            ...
            return (
                array_ops.one_hot(indices_i, depth=4, on_value=2.0, off_value=-2.0),
        ...
        def loop_fn(i):
            ...
            return [
                array_ops.searchsorted(
                    inputs_i, values, out_type=dtypes.int32, side="left"
                ),  # creates LowerBound op.
                array_ops.searchsorted(
    ...
    def test_unpack(self):
        ...
        def loop_fn(i):
            x_i = array_ops.gather(x, i)
            return array_ops.unstack(x_i, 4, axis=-1), array_ops.unstack(x_i, 3, axis=1)
    ...
    def test_split_v(self):
        ...
        def loop_fn(i):
            x1 = array_ops.gather(x, i)
            return (
                array_ops.split(x1, [2, 1, 3], axis=0),
    ...
    def test_concat_v2(self):
        ...
        def loop_fn(i):
            ...
            return [
                ...
                array_ops.concat(
                    [x1, x1, y], axis=constant_op.constant(0, dtype=dtypes.int64)
                ),
            ]
    ...
    def test_diag_part(self):
        for x in (
            random_ops.random_uniform([3, 2, 2]),
