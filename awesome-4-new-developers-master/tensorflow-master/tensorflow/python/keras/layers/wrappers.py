...
class TimeDistributed(Wrapper):
  ...
  """
    ...
    """
        ...
        inner_inputs = nest.map_structure_up_to(
            inputs, array_ops.reshape, inputs, inner_input_shape
        )
        ...
        if output_mask is None:
            ...
            if output_mask_int_shape is None:
                ...
                if mask is not None:
                    ...
                    output_mask_int_shape = backend.compute_output_shape(input_shape)[
                        :-1
                    ]
  ...
  """
    ...
    def __call__(self, inputs, initial_state=None, constants=None, **kwargs):
        ...
        if initial_state is not None:
            ...
            state_specs = [
                InputSpec(shape=backend.int_shape(state)) for state in initial_state
            ]
