...
@parameterized.named_parameters(
    ...
    dict(
        testcase_name="list_of_built_in_fn_and_list", value=[metrics.mae, [metrics.mae]]
    ),
    dict(
        testcase_name="list_of_built_in_class_and_list",
        value=[metrics.MeanAbsoluteError, [metrics.MeanAbsoluteError]],
    ),
    dict(testcase_name="list_of_custom_fn_and_list", value=[_my_mae, [_my_mae]]),
    dict(
        testcase_name="list_of_custom_class_and_list",
        value=[MyMeanAbsoluteError, [MyMeanAbsoluteError]],
    ),
    dict(
        testcase_name="list_of_lists_of_custom_fns", value=[[_my_mae], [_my_mae, "mae"]]
    ),
    dict(
    ...
    dict(testcase_name="dict_of_string", value={"output": "mae", "output_1": "mae"}),
    dict(
