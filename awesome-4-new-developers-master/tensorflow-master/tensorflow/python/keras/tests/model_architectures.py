...
ModelFn = collections.namedtuple("ModelFn", ["model", "input_shape", "target_shape"])
...
def shared_layer_functional():
    ...
    auxiliary_output = keras.layers.Dense(1, activation="sigmoid", name="aux_output")(
        lstm_out
    )
...
ALL_MODELS = [
    ...
    ("nested_subclassed_in_functional_model", nested_subclassed_in_functional_model),
    ("nested_functional_in_subclassed_model", nested_functional_in_subclassed_model),
