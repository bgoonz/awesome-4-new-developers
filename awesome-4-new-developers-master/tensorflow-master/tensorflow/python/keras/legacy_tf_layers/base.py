...
@keras_export(v1=["keras.__internal__.legacy.layers.experimental.keras_style_scope"])
...
@keras_export(v1=["keras.__internal__.legacy.layers.experimental.set_keras_style"])
...
class Layer(base_layer.Layer):
  ...
  """
    ...
    def __setattr__(self, value, name):
        ...
        super(trackable.Trackable, self).__setattr__(
            value, name
