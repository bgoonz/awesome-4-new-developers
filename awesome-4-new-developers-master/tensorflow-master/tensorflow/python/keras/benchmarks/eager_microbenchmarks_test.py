...
class MicroBenchmarksBase(tf.test.Benchmark):
    ...
    def run_report(self, run_benchmark, func, num_iters, execution_mode=None):
        ...
        self.report_benchmark(
            iters=num_iters, wall_time=mean_us, metrics=metrics, name=benchmark_name
        )
...
class KerasLayerCallOverheadBenchmarks(  # pylint: disable=undefined-variable
    ...
    _benchmark_parameters = [
        ("advanced_activations_leaky_relu", tf.keras.layers.LeakyReLU(), (1, 1)),
        ...
        ("core_dropout", tf.keras.layers.Dropout(0.5), (1, 1), {"training": True}),
        ...
        ("convolutional_conv3d", tf.keras.layers.Conv3D(1, (1, 1, 1)), (1, 1, 1, 1, 1)),
        (
