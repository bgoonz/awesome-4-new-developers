...
class FromTensorSlicesTest(test_base.DatasetTestBase, parameterized.TestCase):
    ...
    def testFromTensorSlicesRagged(self):
        ...
        expected = [
            (
                ragged_factory_ops.constant_value([[0]]),
...
class FromTensorSlicesRandomAccessTest(
...
class FromTensorSlicesCheckpointTest(
    ...
    def test(self, verify_fn):
        ...
        verify_fn(
            self, lambda: self._build_tensor_slices_dataset(components), num_outputs=4
        )
