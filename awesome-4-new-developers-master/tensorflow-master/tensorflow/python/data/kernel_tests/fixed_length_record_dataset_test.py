...
class FixedLengthRecordDatasetTest(
    FixedLengthRecordDatasetTestBase, parameterized.TestCase
):
    ...
    def testFixedLengthRecordDatasetParallelRead(self):
        ...
        self.assertDatasetProduces(
            dataset, expected_output=expected_output, assert_items_equal=True
        )
