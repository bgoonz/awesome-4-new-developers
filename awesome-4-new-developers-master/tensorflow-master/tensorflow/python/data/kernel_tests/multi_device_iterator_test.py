...
cls_combination = combinations.combine(
    cls=[
        combinations.NamedObject(
            "MultiDeviceIterator", multi_device_iterator_ops.MultiDeviceIterator
        ),
        combinations.NamedObject(
...
class OwnedMultiDeviceIteratorTest(test_base.DatasetTestBase, parameterized.TestCase):
    ...
    def testMultipleInitializations(self):
        ...
        for _ in range(5):
            multi_device_iterator = multi_device_iterator_ops.OwnedMultiDeviceIterator(
                dataset, [self._devices[1], self._devices[2]]
            )
    ...
    def testLimitedRetracing(self):
        ...
        for _ in range(10):
            ...
            multi_device_iterator2 = multi_device_iterator_ops.OwnedMultiDeviceIterator(
