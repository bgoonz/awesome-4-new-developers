...
def save(dataset, path, compression=None, shard_func=None, checkpoint_args=None):
...
def _set_save_dataset_attributes(dataset, shard_func, path):
    ...
    wrapped_func = dataset_ops.StructuredFunctionWrapper(
        shard_func, "save()", input_structure=dataset.element_spec, add_to_graph=False
    )
...
class _LoadDataset(dataset_ops.DatasetSource):
    ...
    def __init__(self, path, element_spec=None, compression=None, reader_func=None):
