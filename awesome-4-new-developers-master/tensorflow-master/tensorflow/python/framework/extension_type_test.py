...
class ExtensionTypeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    def testConstructorSignature(self):
        ...
        expected_parameters = [
            ...
            tf_inspect.Parameter(
                "x", tf_inspect.Parameter.POSITIONAL_OR_KEYWORD, annotation=ops.Tensor
            ),
            tf_inspect.Parameter(
                "y",
    ...
    def testSimpleCond(self):
        ...
        x_2 = control_flow_ops.cond(constant_op.constant(True), lambda: x, lambda: y)
        y_2 = control_flow_ops.cond(constant_op.constant(False), lambda: x, lambda: y)
    ...
    def testPackedEncoding(self):
        ...
        with self.assertRaisesRegex(
            ValueError, "don't have the same"
