...
class OpDefLibraryTest(test_util.TensorFlowTestCase):
    ...
    def testSimpleFailures(self):
        with ops.Graph().as_default():
            ...
            self.assertTrue("No argument for input a" in str(cm.exception))
    ...
    def testPolymorphic(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception), "Should not specify value for inferred attr 'T'."
            )
    ...
    def testPolymorphicOut(self):
        ...
        """,
            ...
            self.assertEqual(str(cm.exception), "No argument for attr T")

            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op("PolymorphicOut", T=None)
            self.assertEqual(
                str(cm.exception), "Expected DataType for argument 'T' not None."
            )
    ...
    def testTypeList(self):
        ...
        """,
            ...
            self.assertStartsWith(
                str(cm.exception),
                "Expected list for 'a' " "argument to 'TypeList' Op, not ",
            )
    ...
    def testAttr(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception), "Expected int for argument 'a' not 'bad'."
            )

            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op("Attr", a=[12])
            self.assertEqual(
                str(cm.exception), "Expected int for argument 'a' not [12]."
            )

            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op("Attr", a=None)
            self.assertEqual(
                str(cm.exception), "Expected int for argument 'a' not None."
            )
    ...
    def testAttrFloat(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception), "Expected float for argument 'a' not 'bad'."
            )
    ...
    def testAttrFuncWithFuncWithAttrs(self):
        ...
        """
                % compat.as_str(concrete_fn.name),
                op.node_def,
            )
    ...
    def testAttrBool(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception), "Expected bool for argument 'a' not []."
            )
    ...
    def testNIntsIn(self):
        ...
        """,
            ...
            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op(
                    "NIntsIn",
                    a=[self.Tensor(dtypes.string), self.Tensor(dtypes.string)],
                )
            self.assertEqual(
                str(cm.exception),
            ...
            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op(
                    "NIntsIn", a=[self.Tensor(dtypes.int32), self.Tensor(dtypes.string)]
                )
            self.assertEqual(
                str(cm.exception),
            ...
            self.assertStartsWith(
                str(cm.exception),
                "Expected list for 'a' argument " "to 'NIntsIn' Op, not ",
            )
    ...
    def testNPolymorphicIn(self):
        ...
        """,
            ...
            op = op_def_library.apply_op(
                "NPolymorphicIn", a=[1, self.Tensor(dtypes.float32, name="x")], name="q"
            )
            self.assertProtoEquals(
                """
        ...
        """,
            ...
            self.assertStartsWith(
                str(cm.exception),
                "Expected list for 'a' argument " "to 'NPolymorphicIn' Op, not ",
            )
    ...
    def testNIntsOut(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception), "Expected int for argument 'N' not [3]."
            )
    ...
    def testNPolymorphicOut(self):
        ...
        """,
            ...
            self.assertEqual(
                str(cm.exception),
                "Attr 'N' of 'NPolymorphicOut' Op " "passed 1 less than minimum 2.",
            )

            with self.assertRaises(TypeError) as cm:
                op_def_library.apply_op("NPolymorphicOut", N=3, T=[dtypes.string])
            self.assertEqual(
                str(cm.exception), "Expected DataType for argument 'T' not [tf.string]."
            )
