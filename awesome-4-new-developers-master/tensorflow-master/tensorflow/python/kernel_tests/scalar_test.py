...
class ScalarTest(test.TestCase):
    ...
    def testUnsortedSegmentSum(self):
        self.check(
            ...
            (7, 1, [4]),
            "num_segments should be a scalar",
            [0, 7, 0, 0],
        )
