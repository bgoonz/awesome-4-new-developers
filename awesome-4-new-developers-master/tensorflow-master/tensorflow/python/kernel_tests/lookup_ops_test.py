...
class StaticHashTableTest(BaseLookupTableTest):
    ...
    def testMultipleSessions(self):
        ...
        values = constant_op.constant([0, 1, 2], dtypes.int64)
        table = self.getHashTable()(
            lookup_ops.KeyValueTensorInitializer(keys, values), default_val, name="t1"
        )
    ...
    def testTableUseInFunction(self):
        ...
        values = constant_op.constant(["brain", "salad", "surgery"])
        table = self.getHashTable()(
            lookup_ops.KeyValueTensorInitializer(keys, values), "n/a"
        )
...
class DenseHashTableOpTest(test.TestCase):
    def testBasic(self):
        ...
        table = lookup_ops.DenseHashTable(
            dtypes.int64, dtypes.int64, default_value=-1, empty_key=0, deleted_key=-1
        )
    ...
    def testBasicBool(self):
        ...
        table = lookup_ops.DenseHashTable(
            dtypes.int64, dtypes.bool, default_value=False, empty_key=0, deleted_key=-1
        )
        self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testCustomEmptyKey(self):
        ...
        values = constant_op.constant([0, 1, 2], dtypes.int64)
        table = lookup_ops.DenseHashTable(
            dtypes.int64, dtypes.int64, default_value=-1, empty_key=12, deleted_key=-1
        )
        self.assertAllEqual(0, self.evaluate(table.size()))
...
class MutableHashTableOpTest(test.TestCase):
    def testMutableHashTable(self):
        ...
        values = constant_op.constant([0, 1, 2, 3], dtypes.int64)
        table = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testSharing(self):
        ...
        table = lookup_ops.MutableHashTable(dtypes.int64, dtypes.string, "-", name="t1")
    ...
    def testMutableHashTableExportInsert(self):
        ...
        table1 = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        ...
        table2 = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        self.assertAllEqual(0, self.evaluate(table2.size()))
    ...
    def testMutableHashTableInvalidDefaultValue(self):
        ...
        with self.assertRaisesOpError("Default value must be a vector"):
            table = lookup_ops.MutableHashTable(
                dtypes.string, dtypes.int64, default_val
            )
            self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testMultipleMutableHashTables(self):
        ...
        table1 = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        table2 = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        table3 = lookup_ops.MutableHashTable(dtypes.string, dtypes.int64, default_val)
        self.evaluate(table1.insert(keys, values))
    ...
    def testMutableHashTableStringFloat(self):
        ...
        table = lookup_ops.MutableHashTable(dtypes.string, dtypes.float32, default_val)
        self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testMutableHashTableIntFloat(self):
        ...
        table = lookup_ops.MutableHashTable(dtypes.int64, dtypes.float32, default_val)
        self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testMutableHashTableInt64String(self):
        ...
        values = constant_op.constant(["brain", "salad", "surgery"])
        table = lookup_ops.MutableHashTable(dtypes.int64, dtypes.string, default_val)
        self.assertAllEqual(0, self.evaluate(table.size()))
    ...
    def testExportShapeInference(self):
        default_value = -1
        table = lookup_ops.MutableHashTable(
            dtypes.int64, dtypes.int64, default_value=default_value
        )
        actual_shapes = [t.shape for t in table.export()]
        inferred_shapes = []
