                    ...
                    for k in xrange(f_shape[2]):
                        for w in xrange(y_shape[2]):
                            for h in xrange(y_shape[1]):
                                ...
                                h_in = (
                                    h % strides[1] == 0 and h > 0 and h < y_shape[1] - 1
                                )
                                w_in = (
                                    w % strides[2] == 0 and w > 0 and w < y_shape[2] - 1
                                )
                                if h_in and w_in:
                                    target += 9
                                elif h_in or w_in:
                    ...
                    for k in xrange(f_shape[2]):
                        for w in xrange(y_shape[3]):
                            for h in xrange(y_shape[2]):
                                ...
                                # We add a case for locations divisible by the stride.
                                h_in = (
                                    h % strides[2] == 0 and h > 0 and h < y_shape[2] - 1
                                )
                                w_in = (
                                    w % strides[3] == 0 and w > 0 and w < y_shape[3] - 1
                                )
                                if h_in and w_in:
                                    target += 9.0
                                elif h_in or w_in:
                        ...
                        for w in xrange(pad, y_shape[3] - pad):
                            for h in xrange(pad, y_shape[2] - pad):
                                ...
                                h_in = (
                                    h % strides[2] == 0
                                    and h > pad
                                    and h < y_shape[2] - 1 - pad
                                )
                                w_in = (
                                    w % strides[3] == 0
                                    and w > pad
                                    and w < y_shape[3] - 1 - pad
                                )
                                if h_in and w_in:
                                    target += 9.0
                                elif h_in or w_in:
