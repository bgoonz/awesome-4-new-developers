...
_counter_interpreter_creation = monitoring.Counter(
    ...
    "Counter for number of interpreter created in Python.",
    "language",
)
...
_counter_conversion_attempt = monitoring.Counter(
    "/tensorflow/lite/convert/attempt", "Counter for number of conversion attempts."
)

_counter_conversion_success = monitoring.Counter(
    "/tensorflow/lite/convert/success", "Counter for number of successful conversions."
)
  ...
  """
    ...
    def __init__(
        ...
        if model_hash and not model_path or not model_hash and model_path:
            raise ValueError(
                "Both model metadata(model_hash, model_path) should be "
