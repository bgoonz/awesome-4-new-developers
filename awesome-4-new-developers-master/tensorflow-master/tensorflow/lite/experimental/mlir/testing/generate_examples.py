...
from tensorflow.lite.testing.op_tests.broadcast_gradient_args import (
...
from tensorflow.lite.testing.op_tests.conv3d_transpose import (
    make_conv3d_transpose_tests,
)
from tensorflow.lite.testing.op_tests.conv_bias_activation import (
    make_conv_bias_relu6_tests,
)
...
from tensorflow.lite.testing.op_tests.identify_dilated_conv import (
    make_identify_dilated_conv_tests,
)
from tensorflow.lite.testing.op_tests.identify_dilated_conv1d import (
    make_identify_dilated_conv1d_tests,
)
...
from tensorflow.lite.testing.op_tests.max_pool_with_argmax import (
    make_max_pool_with_argmax_tests,
)
...
from tensorflow.lite.testing.op_tests.shape_to_strided_slice import (
    make_shape_to_strided_slice_tests,
)
from tensorflow.lite.testing.op_tests.softplus import make_softplus_tests
from tensorflow.lite.testing.op_tests.static_hashtable import (
    make_static_hashtable_tests,
)
from tensorflow.lite.testing.op_tests.static_rnn_with_control_flow_v2 import (
    make_static_rnn_with_control_flow_v2_tests,
)
from tensorflow.lite.testing.op_tests.stft import make_stft_tests
from tensorflow.lite.testing.op_tests.tensor_list_concat import (
    make_tensor_list_concat_tests,
)
from tensorflow.lite.testing.op_tests.tensor_list_dynamic_shape import (
    make_tensor_list_dynamic_shape_tests,
)
from tensorflow.lite.testing.op_tests.tensor_list_get_item import (
    make_tensor_list_get_item_tests,
)
from tensorflow.lite.testing.op_tests.tensor_list_length import (
    make_tensor_list_length_tests,
)
from tensorflow.lite.testing.op_tests.tensor_list_resize import (
    make_tensor_list_resize_tests,
)
from tensorflow.lite.testing.op_tests.tensor_list_set_item import (
    make_tensor_list_set_item_tests,
)
from tensorflow.lite.testing.op_tests.tensor_scatter_add import (
    make_tensor_scatter_add_tests,
)
from tensorflow.lite.testing.op_tests.tensor_scatter_update import (
    make_tensor_scatter_update_tests,
)
...
parser.add_argument("output_path", help="Directory where the outputs will be go.")
parser.add_argument(
    "--zip_to_output", type=str, help="Particular zip to output.", required=True
)
parser.add_argument(
    "--known_bugs_are_errors",
    action="store_true",
    help=(
        "If a particular model is affected by a known bug,"
...
parser.add_argument(
    ...
    type=str,
    help=(
        "Comma-separated list of test set names to generate. "
