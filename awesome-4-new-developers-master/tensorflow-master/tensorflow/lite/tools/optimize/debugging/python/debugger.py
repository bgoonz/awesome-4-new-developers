...
try:
    ...
    from tensorflow.lite.python import (
        metrics_nonportable as metrics_stub,
    )  # type: ignore
...
class QuantizationDebugger:
  ...
  """
    ...
    """
        ...
        self._quant_interpreter = tf.lite.Interpreter(model_content=self.quant_model)
        self._float_interpreter = None
    ...
    def _get_output_tensors(self, interpreter: tf.lite.Interpreter) -> List[np.ndarray]:
