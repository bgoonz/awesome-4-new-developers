var CHUNK = {
  ...
  gameHeight: function () {
    return (
      this.attrs.gameHeight ||
      (this.attrs.gameHeight = this.canvasHeight / this.pixelSize)
    );
  },
  gameWidth: function () {
    return (
      this.attrs.gameWidth ||
      (this.attrs.gameWidth = this.canvasWidth / this.pixelSize)
    );
  },
  canvas: function () {
    if (CHUNK.context) {
  ...
  drawPixel: function (color, pixel) {
    ...
    CHUNK.context.fillRect(
      translatedPixel.left,
      translatedPixel.top,
      CHUNK.pixelSize,
      CHUNK.pixelSize
    );
  ...
  translatePixel: function (pixel) {
    return {
      left: pixel.left * CHUNK.pixelSize,
