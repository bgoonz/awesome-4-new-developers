...
- **[Sketch 3 Tutorials](https://www.youtube.com/playlist?list=PLLnpHn493BHE6UIsdKYlS5zu-ZYvx22CS)** (25 _awesome_ lessons for beginners)
...
- [SketchCasts](http://www.sketchcasts.net/) _(paid mostly)_
...
- [Designer News](https://www.designernews.co/) _(people talk a lot about Sketch there!)_
...
Sketch has got a **fast-growing community**. Joining them (_see [Community](#community) section ↑_), following their [blog](http://bohemiancoding.tumblr.com/) and subscribing to their [newsletter](https://bohemian.curated.co/) are the best ways to keep up to date so far.
