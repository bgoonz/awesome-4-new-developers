...
Development state: [![Build Status](https://travis-ci.org/ahkscript/awesome-AutoHotkey.svg)](https://travis-ci.org/ahkscript/awesome-AutoHotkey) [![awesome_bot](https://img.shields.io/badge/PoweredBy-awesome_bot-yellow.svg)](https://github.com/dkhamsing/awesome_bot)
...
_List of useful AutoHotkey libraries. Library is code that has some reusable functionality that can be combined with your own code in order to create new functionality._
...
### <span id="libraries-data-format"></span>Data format
...
### <span id="libraries-data-structs-algorithms"></span>Data Structures and Algorithms
...
### <span id="libraries-graphics"></span>Graphics
...
### <span id="libraries-gui"></span>GUI
...
### <span id="libraries-plotting"></span>Plotting (graphs, bars, charts and etc)
...
### <span id="libraries-system"></span>System
...
- [TF](https://github.com/hi5/TF) - by hi5 - Functions for manipulation of text files such as _.txt,_ .ahk, _.html,_ .css etc and Strings (or variables). Forum thread: [link](https://autohotkey.com/boards/viewtopic.php?f=6&t=576).

## Library Distributions

_List of useful AutoHotkey library distributions. Library Distribution is a system that is made for distributing libraries._
...
_List of useful AutoHotkey scripts. Script is code that is intended to be used as standalone programs, and is not meant to be integrated with other code._

### <span id="scripts-clipboard"></span>Clipboard
...
### <span id="scripts-filesystem"></span>Filesystem
...
### <span id="scripts-maths"></span>Maths
...
_List of useful AutoHotkey tools. Tools made for AutoHotkey_
...
- [IronAHK](https://github.com/polyethene/IronAHK) - Cross platform .NET rewrite - _unfinished_.
...
- [LibLua](https://autohotkey.com/board/topic/40690-ahk-lua-interop-stdlib-proof-of-concept/) - _Note: lua.ahk and lua_ahkfunctions.ahk can be found [here](https://code.google.com/archive/p/wow-vending-machine/source)_.
...
_List of useful AutoHotkey tutorials._

### <span id="tutorials-classes"></span>Classes
...
_Forks of AHK which add new features to the core language_
