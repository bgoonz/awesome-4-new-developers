...
-   [CTFlearn](https://ctflearn.com) (email adress _requested_)
-   [Google Ctf](https://capturetheflag.withgoogle.com) (email adress _requested_)
-   [Hacker101](https://ctf.hacker101.com) (email adress _requested_)
-   [Hackthebox](https://www.hackthebox.eu) (email adress _requested_)
-   [Overthewire Wargames fungame to practice CTF](https://overthewire.org/wargames/bandit)
-   [Picoctf](https://picoctf.org/resources) (email adress _requested_)
-   [TryHackMe](https://tryhackme.com) (email adress _requested_)
