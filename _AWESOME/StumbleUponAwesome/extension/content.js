...
function showStumbleInfo(request) {
  ...
  rabbitHoleBubble.innerHTML = `
        <img id="sax-rabbit-hole-exit-button" src=${chrome.extension.getURL(
          "images/close.svg"
        )} />
        <img id="sax-rabbit-hole-spiral" src=${chrome.extension.getURL(
          "images/spiral.png"
        )} />
        <div id="sax-rabbit-hole-text">
            <p id="sax-rabbit-hole-text-top">In rabbit hole:</p>
            <p id="sax-rabbit-hole-text-bottom">${
  ...
  content.innerHTML = `
        <span id="sax-label-small-primary">
            Source: ${
              request.stumbleUrl.title
                ? `'${request.stumbleUrl.title}'`
                : `curated`
            } from awesome list about 
        </span>
        ...
        <div id="sax-rabbit-hole">
            <img id="sax-rabbit-hole-image" src=${chrome.extension.getURL(
  ...
  rabbitHole.addEventListener("mouseenter", () => {
    rabbitHole.setAttribute(
      "src",
      chrome.extension.getURL("images/rabbithole.gif")
    );
  ...
  rabbitHole.addEventListener("mouseleave", () => {
    rabbitHole.setAttribute(
      "src",
      chrome.extension.getURL("images/rabbithole.png")
    );
  ...
  var rabbitHoleExitButton = document.getElementById(
    "sax-rabbit-hole-exit-button"
  );
...
function showWelcomeInfo(request) {
  ...
  text.innerHTML = `<p id="sax-welcome-text-title">
    ...
    Stumble by clicking on the ⚡️ icon in the toolbar, or press <span id="sax-keyboard-shortcut">${
      os === "mac" ? "Alt+Shift+S" : "Alt+Shift+S"
    }
    </span>
    </br></br>
    <div id="sax-welcome-new-feature">
        <img id="sax-rabbit-hole-spiral-2" src=${chrome.extension.getURL(
          "images/spiral.png"
        )} />
        ...
        <img id="sax-rabbit-hole-image-2" src=${chrome.extension.getURL(
