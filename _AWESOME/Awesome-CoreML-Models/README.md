...
_Models that take image data as input and output useful information about the image._
...
_Models that transform images._
...
_Models that process text data_
...
_Tools that help visualize CoreML Models_

- [Netron](https://lutzroeder.github.io/Netron)

# Supported formats

_List of model formats that could be converted to Core ML with examples_
...
_Collections of machine learning models that could be converted to Core ML_
...
_Individual machine learning models that could be converted to Core ML. We'll keep adjusting the list as they become converted._
