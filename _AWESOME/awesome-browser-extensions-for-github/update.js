...
function findRecentVersion(dateList) {
  return format(
    new Date(Math.max(...dateList.filter(Boolean).map((a) => new Date(a)))),
    "d MMM yyyy"
  );
}
