[![Awesome IAM](https://github.com/kdeldycke/awesome-iam/raw/main/assets/awesome-iam-header.jpg)](https://github.com/kdeldycke/awesome-iam/)

**A curated list of resources on managing accounts, users, roles, permissions, authentication and authorization.** [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome)

_Trusting is hard. Knowing who to trust, even harder._  
— Maria V. Snyder<sup>[\[1\]](#intro-quote-def)</sup>
...
<img src="./assets/cloud-software-stack-iam.jpg" style="width:50.0%" />
...
- [IAM Is The Real Cloud Lock-In](https://forrestbrazeal.com/2019/02/18/cloud-irregular-iam-is-the-real-cloud-lock-in/) - A little _click-baity_, but author admit that “It depends on how much you trust them to 1. Stay in business; 2. Not jack up your prices; 3. Not deprecate services out from under you; 4. Provide more value to you in business acceleration than they take away in flexibility.”
...
The old _OpenID_ is dead; the new _OpenID Connect_ is very much not-dead.
...
<span id="intro-quote-def">\[1\]</span>: [_Poison Study_](https://amzn.com/0778324338/?tag=kevideld-20) (Mira, 2007). [\[↑\]](#intro-quote-ref)
