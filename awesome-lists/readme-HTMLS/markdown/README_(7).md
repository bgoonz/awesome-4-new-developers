...
- [rbenv (Meroje)](https://github.com/Meroje/zsh-rbenv) - Inspired by <https://github.com/lukechilds/zsh-nvm/>, makes it easier to work with ruby rbenvs.
...
- [sudo](https://github.com/hcgraf/zsh-sudo) - The `sudo` plugin from oh-my-zsh, extracted to a standalone. Toggles `sudo` before the current/previous command by pressing _ESC-ESC_ in emacs-mode or vi-command mode.
...
- [wdnote](https://github.com/Vesdii/zsh-wdnote) - Prints the contents of a `.wdnote` if present upon changing directories.
...
- [bunnyruni.min](https://github.com/mikeumus/bunnyruni.min) - <span class="citation" data-cites="jopcode">\[@jopcode's\]</span>(https://github.com/jopcode) [bunnyruni](https://github.com/jopcode/oh-my-zsh-bunnyruni-theme) ZSH theme, modified to just display time and directory.
...
- [celestialorb](https://github.com/celestialorb/zsh-theme) - Powerline-inspired theme by <span class="citation" data-cites="celestialorb">@celestialorb</span>. Includes `git` status decorations, Kubernetes cluster information (if any), current AWS profile and region, and active virtualenv.
...
- [emojeer](https://github.com/lxynox/emojeer-ohmyzsh) - Emoji flavored [oh-my-zsh](ohmyzsh/ohmyzsh) theme.
...
- [rummik](https://github.com/rummik/zsh-theme) - <span class="citation" data-cites="rummik">@rummik</span>’s theme. Supports [psmin](https://gitlab.com/zick.kim/zsh/zsh-psmin), and `git` status information in the prompt.
