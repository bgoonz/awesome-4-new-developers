...
def run_graph(
    wav_data, labels, input_layer_name, output_layer_name, num_top_predictions
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--how_many_labels", type=int, default=3, help="Number of results to show."
    )
