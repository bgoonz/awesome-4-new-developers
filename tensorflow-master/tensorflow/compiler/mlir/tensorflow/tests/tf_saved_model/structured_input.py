...
class TestModule(tf.Module):
    ...
    @tf.function(
        input_signature=[tf.TensorSpec([1], tf.float32), tf.TensorSpec([2], tf.float32)]
    )
    ...
    @tf.function(
        input_signature=[
            {"x": tf.TensorSpec([1], tf.float32), "y": tf.TensorSpec([2], tf.float32)}
        ]
    )
    ...
    @tf.function(
        input_signature=[
            {"y": tf.TensorSpec([2], tf.float32), "x": tf.TensorSpec([1], tf.float32)}
        ]
    )
    ...
    @tf.function(
        input_signature=[
            {
                "x": [tf.TensorSpec([1], tf.float32), tf.TensorSpec([2], tf.float32)],
