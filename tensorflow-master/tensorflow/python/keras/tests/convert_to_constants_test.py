...
class VariablesToConstantsTest(test.TestCase):
    ...
    def testKerasModel(self):
        ...
        input_data = {"x": constant_op.constant(1.0, shape=[1, 1])}
        ...
        @def_function.function(
            input_signature=[tensor_spec.TensorSpec(shape=[1, 1], dtype=dtypes.float32)]
        )
        def to_save(x):
            return model(x)
    ...
    def testEmbeddings(self):
        ...
        class EmbeddingModel(keras.Model):
            ...
            @def_function.function(
                input_signature=[tensor_spec.TensorSpec(shape=(20), dtype=dtypes.int32)]
            )
            def func(self, x):
