...
def sparse_adagrad_update_numpy(param, accum, gindexs, gvalues, lr=0.001, epsilon=1e-7):
    ...
    def testSparseRepeatedIndices(self):
        ...
        with ops.Graph().as_default():
            for dtype in _DATA_TYPES:
                ...
                repeated_index_update_var = variables.Variable(var_np, dtype=dtype)
    ...
    def testSparseRepeatedIndicesByEmbeddingLookUp(self):
        ...
        with ops.Graph().as_default():
            for dtype in _DATA_TYPES:
                ...
                loss_aggregated = (
                    lambda: 2
                    * math_ops.reduce_sum(  # pylint: disable=g-long-lambda
