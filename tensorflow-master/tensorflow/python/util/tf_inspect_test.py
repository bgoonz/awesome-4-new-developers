...
class TfInspectTest(test.TestCase):
    ...
    def testGetArgSpecOnDecoratorThatChangesArgspec(self):
        argspec = tf_inspect.ArgSpec(
            args=["a", "b", "c"], varargs=None, keywords=None, defaults=(1, "hello")
        )
    ...
    def testGetArgSpecReturnsOutermostDecoratorThatChangesArgspec(self):
        ...
        inner_decorator = tf_decorator.TFDecorator(
            "", test_undecorated_function, "", inner_argspec
        )
        outer_decorator = tf_decorator.TFDecorator(
            "", inner_decorator, "", outer_argspec
        )
    ...
    def testGetArgSpecOnPartialValidArgspec(self):
        ...
        argspec = tf_inspect.ArgSpec(
            args=["m", "n", "l", "k"], varargs=None, keywords=None, defaults=(7, 2, 4)
        )
    ...
    def testGetArgSpecOnPartialWithDecoratorThatChangesArgspec(self):
        ...
        partial_argspec = tf_inspect.ArgSpec(
            args=["a", "b", "c"], varargs=None, keywords=None, defaults=(2, 1, "hello")
        )
        partial_with_decorator = functools.partial(decorator, a=2)

        self.assertEqual(argspec, tf_inspect.getargspec(decorator))
        self.assertEqual(partial_argspec, tf_inspect.getargspec(partial_with_decorator))
    ...
    def testGetFile(self):
        self.assertTrue(
            "tf_inspect_test.py"
            in tf_inspect.getfile(test_decorated_function_with_defaults)
        )
        self.assertTrue(
            "tf_decorator.py"
            in tf_inspect.getfile(test_decorator("decorator")(tf_decorator.unwrap))
        )
...
'''
    ...
    def testGetSourceFile(self):
        self.assertEqual(
            __file__, tf_inspect.getsourcefile(test_decorated_function_with_defaults)
        )
    ...
    def testStack(self):
        ...
        self.assertEqual(expected_stack[0][2], actual_stack[0][2] - 1)  # Line number
...
class TfInspectGetCallArgsTest(test.TestCase):
    ...
    def testClashingParameterNames(self):
        ...
        self.assertEqual(
            ...
            {"positional": 0, "func": 1, "func_and_positional": 2, "kwargs": 3},
        )
        kwargs = dict(func=4, func_and_positional=5, kwargs=6)
        self.assertEqual(
            tf_inspect.getcallargs(func, 0, **kwargs),
            {"positional": 0, "func": 4, "func_and_positional": 5, "kwargs": 6},
        )
    ...
    def testUsesOutermostDecoratorsArgSpec(self):
        ...
        decorated = tf_decorator.make_decorator(
            ...
            decorator_argspec=tf_inspect.ArgSpec(
                args=["a", "b", "c"], varargs=None, keywords=None, defaults=(3, "hello")
            ),
        )
