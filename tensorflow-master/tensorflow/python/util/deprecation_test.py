...
class DeprecatedAliasTest(test.TestCase):
    ...
    def test_function_alias(self, mock_warning):
        deprecated_func = deprecation.deprecated_alias(
            "deprecated.func", "real.func", logging.error
        )
    ...
    def test_class_alias(self, mock_warning):
        ...
        deprecated_cls = deprecation.deprecated_alias(
            "deprecated.cls", "real.cls", MyClass
        )
...
class DeprecatedArgsTest(test.TestCase):
    ...
    def test_positional_and_named_with_ok_vals(self, mock_warning):
        ...
        @deprecation.deprecated_args(
            date, instructions, ("d1", None), ("d2", "my_ok_val")
        )
        def _fn(arg0, d1=None, arg1=2, d2=None):
            return arg0 + arg1 if d1 else arg1 + arg0 if d2 else arg0 * arg1
    ...
    def test_kwonlyargs_and_args(self, mock_warning):
        ...
        @deprecation.deprecated_args(
            date, instructions, ("deprecated_arg1", "deprecated_arg2")
        )
...
class DeprecatedArgValuesTest(test.TestCase):
    ...
    def test_static_fn_with_doc(self, mock_warning):
        ...
        @deprecation.deprecated_arg_values(
            date, instructions, warn_once=False, deprecated=True
        )
        def _fn(arg0, arg1, deprecated=True):
            """fn doc.
    ...
    def test_deprecated_arg_values_once(self, mock_warning):
        ...
        @deprecation.deprecated_arg_values(
            date, instructions, warn_once=True, deprecated=True
        )
    ...
    def test_deprecated_multiple_arg_values_once_each(self, mock_warning):
        ...
        @deprecation.deprecated_arg_values(
            date, instructions, warn_once=True, arg0="forbidden", arg1="disallowed"
        )
    ...
    def test_deprecated_arg_values_when_value_is_none(self, mock_warning):
        @deprecation.deprecated_arg_values(
            "2016-07-04", "This is how you update...", warn_once=True, arg0=None
        )
    ...
    def testDeprecatedArgumentLookup(self):
        ...
        self.assertEqual(
            deprecation.deprecated_argument_lookup(
                "val_new", good_value, "val_old", None
            ),
            good_value,
        )
        self.assertEqual(
            deprecation.deprecated_argument_lookup(
                "val_new", None, "val_old", good_value
            ),
            good_value,
        )
        with self.assertRaisesRegex(
            ValueError, "Cannot specify both 'val_old' and 'val_new'"
        ):
            self.assertEqual(
                deprecation.deprecated_argument_lookup(
                    "val_new", good_value, "val_old", good_value
                ),
                good_value,
            )
