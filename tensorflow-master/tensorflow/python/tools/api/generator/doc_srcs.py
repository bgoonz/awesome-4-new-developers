  ...
  """
    ...
    def __init__(self, docstring=None, docstring_module_name=None):
        ...
        if self.docstring is not None and self.docstring_module_name is not None:
            raise ValueError(
                "Only one of `docstring` or `docstring_module_name` can " "be set."
            )
...
_TENSORFLOW_DOC_SOURCES = {
    ...
    "distributions": DocSource(docstring_module_name="ops.distributions.distributions"),
    ...
    "resource_loader": DocSource(docstring_module_name="platform.resource_loader"),
...
_ESTIMATOR_DOC_SOURCES = {
    "estimator": DocSource(docstring_module_name="estimator_lib"),
    "estimator.export": DocSource(docstring_module_name="export.export_lib"),
    "estimator.inputs": DocSource(docstring_module_name="inputs.inputs"),
}
