...
def _count_total_params(reader, count_exclude_pattern=""):
    ...
    if count_exclude_pattern:
        ...
        print(
            "# Excluding %d tensors (%d params) that match %s when counting."
...
def print_tensors_in_checkpoint_file(
    file_name,
    tensor_name,
    all_tensors,
    ...
    try:
        ...
        if all_tensors or all_tensor_names:
            ...
            print(
                ...
                % (
                    tensor_name,
                    var_to_dtype_map[tensor_name].name,
        ...
        print(
            ...
            % _count_total_params(reader, count_exclude_pattern=count_exclude_pattern)
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tensor_name", type=str, default="", help="Name of the tensor to inspect"
    )
    parser.add_argument(
        "--count_exclude_pattern",
        type=str,
