...
def StreamingFilesDataset(
    ...
    filetype: Optional[Union[Text, Callable[[Text], dataset_ops.Dataset]]] = None,
  ...
  """
    ...
    if isinstance(filetype, str):
        ...
        raise ValueError(
            f"Argument `filetype` should be a string or a callable. "
    ...
    def LoadingFunc(h):
        remote_iterator = iterator_ops.Iterator.from_string_handle(
            h,
            dataset_ops.get_legacy_output_types(source_dataset),
    ...
    def MapFn(unused_input):
        ...
        if isinstance(source_dataset_output_types, dtypes.DType):
            ...
            raise ValueError(
                "Source dataset has invalid output types. Only "
    ...
    with ops.device("/job:%s" % worker_job):
        output_dataset = (
            ...
            .repeat()
            .map(MapFn, num_parallel_calls=4 if sloppy else None)
        )
