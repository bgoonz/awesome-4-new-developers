  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(InvalidArgumentError, self).__init__(
            node_def, op, message, INVALID_ARGUMENT, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(DeadlineExceededError, self).__init__(
            node_def, op, message, DEADLINE_EXCEEDED, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(AlreadyExistsError, self).__init__(
            node_def, op, message, ALREADY_EXISTS, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(PermissionDeniedError, self).__init__(
            node_def, op, message, PERMISSION_DENIED, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(UnauthenticatedError, self).__init__(
            node_def, op, message, UNAUTHENTICATED, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(ResourceExhaustedError, self).__init__(
            node_def, op, message, RESOURCE_EXHAUSTED, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(FailedPreconditionError, self).__init__(
            node_def, op, message, FAILED_PRECONDITION, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(OutOfRangeError, self).__init__(
            node_def, op, message, OUT_OF_RANGE, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(UnimplementedError, self).__init__(
            node_def, op, message, UNIMPLEMENTED, *args
        )
  ...
  """
    ...
    def __init__(self, node_def, op, message, *args):
        ...
        super(UnavailableError, self).__init__(
            node_def, op, message, UNAVAILABLE, *args
        )
...
@tf_export(
    v1=["errors.raise_exception_on_not_ok_status"]
