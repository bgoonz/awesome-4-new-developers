...
class UnifiedTapeBenchmark(test.Benchmark):
    ...
    def benchmarkTwoHiddenLayerMnistEagerUnified(self):
        ...
        self.report_benchmark(
            name="TwoHiddenLayerMnistEagerUnified", iters=num_iters, wall_time=duration
        )
    ...
    def benchmarkTenHiddenLayerMnistEagerUnified(self):
        ...
        self.report_benchmark(
            name="TenHiddenLayerMnistEagerUnified", iters=num_iters, wall_time=duration
        )
