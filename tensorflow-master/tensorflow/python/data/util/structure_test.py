...
class StructureTest(test_base.DatasetTestBase, parameterized.TestCase):
    ...
    def testIncompatibleStructure(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            "Cannot create a tensor from the input list because item 0 "
    ...
    def testIncompatibleNestedStructure(self):
        ...
        with self.assertRaisesRegex(
            ValueError, r"Cannot create a tensor from the input list"
        ):
        ...
        with self.assertRaisesRegex(
            ValueError, "Cannot create a tensor from the input list"
        ):
