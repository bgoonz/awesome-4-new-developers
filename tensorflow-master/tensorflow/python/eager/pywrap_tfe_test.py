...
class Tests(test.TestCase):
    ...
    def testFastpathExecute_ResourceVariableMatMulCorrectResponse(self):
        ...
        x = pywrap_tfe.TFE_Py_FastPathExecute(
            ctx, "MatMul", None, m, m, "transpose_a", False, "transpose_b", False
        )
    ...
    def testFastpathExecute_AddNCorrectResponse(self):
        ...
        self.assertAllClose(
            ...
            pywrap_tfe.TFE_Py_FastPathExecute(ctx, "AddN", None, [a_2_by_2, b_2_by_2]),
        )
    ...
    def testFastpathExecute_AddNTapeWrite(self):
        ...
        with backprop.GradientTape(persistent=True) as tape:
            ...
            z1 = pywrap_tfe.TFE_Py_FastPathExecute(
                ctx, "AddN", None, [a_2_by_2, b_2_by_2]
            )
    ...
    def testFastpathExecute_IdentityNCorrectResponse(self):
        ...
        self.assertAllClose(
            ...
            pywrap_tfe.TFE_Py_FastPathExecute(
                ctx, "IdentityN", None, [a_2_by_2, b_2_by_2]
            ),
        )
    ...
    def testFastPathExecute_InvalidAttributes(self):
        ...
        with self.assertRaises(core._FallbackException):
            pywrap_tfe.TFE_Py_FastPathExecute(
                ctx, "Split", None, split_dim, value, "num_split", -1
            )
    ...
    def testFastPathExecute_VeryLargeOutputs(self):
        ...
        with self.assertRaisesRegex(ValueError, "Number of outputs is too big"):
            pywrap_tfe.TFE_Py_FastPathExecute(
                ctx, "Split", None, split_dim, value, "num_split", 1000000000000
            )
    ...
    def testSlowPathExecute_VeryLargeOutputs(self):
        ...
        with self.assertRaisesRegex(ValueError, "Number of outputs is too big"):
            pywrap_tfe.TFE_Py_Execute(
                ctx._handle, None, "Split", [split_dim, value], attrs, 1000000000000
            )
    ...
    def testOpDefDefaultType(self):
        im = np.random.randint(  # pylint: disable=too-many-function-args
            low=0, high=65535, size=100, dtype=np.uint16
        ).reshape(10, 10, 1)
    ...
    def testIntAttrThatDoesNotFitIn32Bits(self):
        ...
        seed = 2 ** 50
        pywrap_tfe.TFE_Py_FastPathExecute(
            ctx, "RandomUniformInt", None, shape, minval, maxval, "seed", seed
        )
