  ...
  """
    ...
    def run_report(self, run_benchmark, func, num_iters, execution_mode=None):
        ...
        if flags.FLAGS.xprof:
            ...
            xprof_link, us_per_example = self.run_with_xprof(
                True, run_benchmark, func, num_iters_xprof, execution_mode, suid
            )
            ...
            xprof_link, us_per_example = self.run_with_xprof(
                False, run_benchmark, func, num_iters_xprof, execution_mode, suid
            )
