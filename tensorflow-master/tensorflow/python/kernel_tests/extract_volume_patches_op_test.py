...
class ExtractVolumePatches(test.TestCase):
    ...
    def testKsize2x2x2Stride1x1x1Valid(self):
        ...
        self._VerifyValues(
            image, ksizes=[2, 2, 2], strides=[1, 1, 1], padding="VALID", patches=patches
        )
    ...
    def testKsize2x2x2Stride1x1x1Same(self):
        ...
        patches = np.array(
            [
                [
                    [
                        [[1, 2, 3, 4, 5, 6, 7, 8], [2, 0, 4, 0, 6, 0, 8, 0]],
                        [[3, 4, 0, 0, 7, 8, 0, 0], [4, 0, 0, 0, 8, 0, 0, 0]],
                    ],
                    [
                        [[5, 6, 7, 8, 0, 0, 0, 0], [6, 0, 8, 0, 0, 0, 0, 0]],
                        [[7, 8, 0, 0, 0, 0, 0, 0], [8, 0, 0, 0, 0, 0, 0, 0]],
                    ],
                ]
            ]
        )
        self._VerifyValues(
            image, ksizes=[2, 2, 2], strides=[1, 1, 1], padding="SAME", patches=patches
        )
