...
class DeterminantOpTest(test.TestCase):
    ...
    def testBasicComplex64(self):
        # 2x2 matrices
        self._compareDeterminant(
            np.array([[2.0, 3.0], [3.0, 4.0]]).astype(np.complex64)
        )
        self._compareDeterminant(
            np.array([[0.0, 0.0], [0.0, 0.0]]).astype(np.complex64)
        )
        self._compareDeterminant(
            np.array([[1.0 + 1.0j, 1.0 - 1.0j], [-1.0 + 1.0j, -1.0 - 1.0j]]).astype(
                np.complex64
            )
        )
        # 5x5 matrices (Eigen forces LU decomposition)
    ...
    def testBasicComplex128(self):
        # 2x2 matrices
        self._compareDeterminant(
            np.array([[2.0, 3.0], [3.0, 4.0]]).astype(np.complex128)
        )
        self._compareDeterminant(
            np.array([[0.0, 0.0], [0.0, 0.0]]).astype(np.complex128)
        )
        self._compareDeterminant(
            np.array([[1.0 + 1.0j, 1.0 - 1.0j], [-1.0 + 1.0j, -1.0 - 1.0j]]).astype(
                np.complex128
    ...
    def testNonSquareMatrix(self):
        ...
        with self.assertRaises(ValueError):
            linalg_ops.matrix_determinant(
                np.array([[1.0, 2.0, 3.0], [3.0, 5.0, 4.0]]).astype(np.float32)
            )
