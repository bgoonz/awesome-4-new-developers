...
class BenchmarkTest(test.TestCase, benchmark.TensorFlowBenchmark):
    def testReportBenchmark(self):
        ...
        proto_file_path = os.path.join(output_dir, "BenchmarkTest.testReportBenchmark")
        ...
        self.report_benchmark(
            ...
            metrics=[
                {"name": "metric_name_1", "value": 0, "min_value": 1},
                {"name": "metric_name_2", "value": 90, "min_value": 0, "max_value": 95},
            ],
        )
