...
def _var_key(var):
    ...
    if (
        distribute_utils.is_distributed_variable(var)
...
class Optimizer(
  ...
  """
    ...
    def _scale_loss(loss_value):
        ops.get_default_graph()._is_loss_scaled_by_optimizer = (
            False
        )  # pylint: disable=protected-access
    ...
    """
        ...
        if distribute_utils.is_distributed_variable(
            slot
        ) and not distribute_utils.is_distributed_variable(var):
