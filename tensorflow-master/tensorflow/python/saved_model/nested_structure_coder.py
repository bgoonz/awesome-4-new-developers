...
class _TensorSpecCodec(object):
    ...
    def can_encode(self, pyobj):
        ...
        return isinstance(pyobj, tensor_spec.TensorSpec) and not isinstance(
            pyobj, tensor_spec.BoundedTensorSpec
        )
...
class _BoundedTensorSpecCodec(object):
    ...
    def do_decode(self, value, decode_fn):
        ...
        return tensor_spec.BoundedTensorSpec(
            shape=decode_fn(struct_pb2.StructuredValue(tensor_shape_value=btsv.shape)),
            dtype=decode_fn(struct_pb2.StructuredValue(tensor_dtype_value=btsv.dtype)),
...
class _TypeSpecCodec(object):
    ...
    def can_encode(self, pyobj):
        ...
        if (
            type(pyobj) in self.TYPE_SPEC_CLASS_TO_PROTO
    ...
    def do_encode(self, type_spec_value, encode_fn):
        ...
        if type_spec_class is None:
            ...
            if isinstance(type_spec_value, extension_type.ExtensionTypeSpec):
                ...
                warnings.warn(
                    "Encoding a StructuredValue with type %s; loading this "
    ...
    def do_decode(self, value, decode_fn):
        ...
        if type_spec_class_enum == struct_pb2.TypeSpecProto.REGISTERED_TYPE_SPEC:
            ...
            try:
                ...
                warnings.warn(
                    "The type %r has not been registered.  Falling back to "
