  ...
  """
    ...
    """
        ...
        with ops.name_scope(name):
            ...
            if (
                self._num_rows_static is not None
    ...
    def _assert_non_singular(self):
        raise errors.InvalidArgumentError(
            node_def=None,
            op=None,
            message="Zero operators are always " "non-invertible.",
        )
    ...
    def _assert_positive_definite(self):
        raise errors.InvalidArgumentError(
            node_def=None,
            op=None,
            message="Zero operators are always " "non-positive definite.",
        )
        ...
        if self.is_square:
            ...
            if adjoint_arg:
                output_shape = array_ops.concat(
                    [
                        array_ops.shape(x)[:-2],
                        [array_ops.shape(x)[-1], array_ops.shape(x)[-2]],
                    ],
                    axis=0,
                )
            else:
