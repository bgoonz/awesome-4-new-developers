...
class StructuredTensorTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    def assertAllEqual(self, a, b, msg=None):
        if not (
            isinstance(a, structured_tensor.StructuredTensor)
    ...
    @parameterized.named_parameters(
        [
            ...
            {"testcase_name": "Rank0_WithNoFields", "shape": [], "fields": {}},
            {
            ...
            },
            {
                ...
                "fields": {
                    ...
                    "s": ragged_factory_ops.constant_value(
                        [[[4]], [], [[5]]], ragged_rank=2
                    ),
                },
            },
            ...
            {"testcase_name": "Rank1_WithNoFields", "shape": [2], "fields": {}},
            {
            ...
            },
            {
                ...
                "fields": {
                    ...
                    "t": ragged_factory_ops.constant_value(
                        [[], [[[12]], [[13]]]], ragged_rank=2
                    ),
                },
            },
            ...
            {"testcase_name": "Rank2_WithNoFields", "shape": [2, 8], "fields": {}},
            {
                "testcase_name": "Rank2_WithNoFieldsAndExplicitRowPartitions",
                "shape": [2, None],
                "row_partitions": lambda: [
                    row_partition.RowPartition.from_row_lengths([3, 7])
                ],
                "fields": {},
            },
            {
                ...
                "shape": [None, None],
                "fields": {"x": [[1, 2, 3], [4, 5, 6]], "y": np.ones([2, 3, 8])},
            ...
            },
            {
                ...
                "fields": lambda: {
                    ...
                    "d": ragged_factory_ops.constant_value([[[1, 2], []], [[3], [4]]]),
                },
                "expected_shape": [2, 2],
            },
            ...
            },
            {
                ...
                "fields": lambda: {
                    ...
                    "g": StructuredTensor.from_pyval(
                        [[[[{"x": j, "y": k}] for k in range(3)] for j in range(2)]]
                    ),
    ...
    def testFromFields(
        self, shape, fields, expected_shape=None, nrows=None, row_partitions=None
    ):
        if callable(fields):
    ...
    @parameterized.parameters(
        [
            ...
            dict(fields={1: 2}, shape=[], err=TypeError, msg="Unexpected type for key"),
            dict(
                fields={"x": object()},
                shape=[],
                err=TypeError,
    ...
    def testPartitionOuterDimsErrors(self):
        ...
        with self.assertRaisesRegex(
            ValueError, r"Shape \(\) must have rank at least 1"
        ):
    ...
    @parameterized.named_parameters(
        [
            ...
            },
            {
                ...
                "expected": lambda: StructuredTensor.from_fields(
                    ...
                    fields={
                        "a": 12,
                        "b": [1, 2, 3],
                        "c": StructuredTensor.from_fields(
                            shape=[], fields={"x": "Z", "y": [10, 20]}
                        ),
                    },
                ),
            },
            {"testcase_name": "EmptyList", "pyval": [], "expected": lambda: []},
            {
            ...
            },
            {
                ...
                "pyval": [{"a": 1}, {"a": 2}],
                "expected": lambda: StructuredTensor.from_fields(
                    shape=[2], fields={"a": [1, 2]}
                ),
            },
            {
                "testcase_name": "VectorOfDictWithNestedStructScalar",
                "pyval": [{"a": 1, "b": {"x": [1, 2]}}, {"a": 2, "b": {"x": [3]}}],
                "expected": lambda: StructuredTensor.from_fields(
                    shape=[2],
                    fields={
                        "a": [1, 2],
                        "b": StructuredTensor.from_fields(
                            shape=[2],
                            fields={"x": ragged_factory_ops.constant([[1, 2], [3]])},
                        ),
                    },
                ),
            },
            ...
            },
            {
                ...
                "expected": lambda: StructuredTensor.from_fields(
                    shape=[2, None],
                    fields={"a": ragged_factory_ops.constant([[1, 2, 3], [4, 5, 6]])},
                ),
            },
            {
    ...
    @parameterized.named_parameters(
        [
            ...
            dict(
                testcase_name="TypeSpecMismatch_DictKey",
                pyval={"a": 1},
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[1],
            ...
            dict(
                testcase_name="TypeSpecMismatch_ListDictKey",
                pyval=[{"a": 1}],
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[1],
                    field_specs={"b": tensor_spec.TensorSpec([], dtypes.int32)},
            ...
            dict(
                testcase_name="TypeSpecMismatch_RankMismatch",
                pyval=[{"a": 1}],
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[],
            ...
            dict(
                testcase_name="TypeSpecMismatch_Scalar",
                pyval=0,
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[], field_specs={}
                ),
            ...
            dict(
                testcase_name="TypeSpecMismatch_ListTensor",
                pyval={"a": [[1]]},
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[],
                    field_specs={"a": tensor_spec.TensorSpec([], dtypes.int32)},
            ...
            dict(
                testcase_name="TypeSpecMismatch_ListTensorDeep",
                pyval={"a": {"b": [[1]]}},
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[],
                    field_specs={
                        "a": structured_tensor.StructuredTensorSpec(
                            shape=[],
                            field_specs={"b": tensor_spec.TensorSpec([], dtypes.int32)},
                        )
                    },
            ...
            dict(
                testcase_name="TypeSpecMismatch_ListTensorDeep_infer",
                pyval={"a": [{"b": [[1]]}, {"b": [["c"]]}]},
                type_spec=None,
                msg=r"Error parsing path \('a', 'b'\)",
            ),
            dict(
                testcase_name="TypeSpecMismatch_ListTensorDeep_infer2",
                pyval=[{"a": 1}, {"a": "c"}],
                type_spec=None,
                msg=r"Error parsing path \('a',\)",
            ),
            dict(
                testcase_name="TypeSpecMismatch_ListSparse",
                pyval=[1, 2],
                type_spec=sparse_tensor.SparseTensorSpec([None], dtypes.int32),
                msg=r"Value at \(\) does not match typespec",
            ),
            dict(
                testcase_name="TypeSpecMismatch_ListStruct",
                pyval=[[1]],
                type_spec=structured_tensor.StructuredTensorSpec(
                    shape=[1, 1],
                    field_specs={"a": tensor_spec.TensorSpec([], dtypes.int32)},
            ...
            dict(
                testcase_name="InconsistentDictionaryDepth",
                pyval=[{}, [{}]],
    ...
    def testRowPartitionsForRaggedTensor(
        self, rt, rt_ragged_rank, rank, expected_row_lengths
    ):
    ...
    def testMergeDimsError(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"Expected outer_axis \(2\) to be less than "
    ...
    @parameterized.named_parameters(
        [
            ...
            dict(
                ...
                st=[{"b": {"a": [[5, 7], []]}}, {"b": {"a": [[5, 1], [3]]}}],
                source_path=("b", "a"),
                new_field_name="new_field",
                expected=[
                    {"b": {"a": [[5, 7], []]}, "new_field": [[5, 7], []]},
                    {"b": {"a": [[5, 1], [3]]}, "new_field": [[5, 1], [3]]},
                ],
            ),
            dict(
            ...
            dict(
                ...
                expected=[
                    ...
                    {"docs": [{"tokens": [5, 15]}], "docs_tokens": [5, 15]},
                ],
            ),
            dict(
            ...
            dict(
                testcase_name="example_4_promote_of_labeled_vector",
                st=[
                    {"user_info": [{"gaia_id": {"vec": [0, 1, 2]}}]},
        ...
        st = StructuredTensor.from_fields(
            {
                "a": StructuredTensor.from_fields(
                    {"b": [[[1, 11], [2, 12]], [[3, 13], [4, 14]]]}, shape=[2, 2, 2]
                )
            },
            shape=[2],
        )
    ...
    @parameterized.parameters(
        [
            ...
            ([{"a": 5}, {"a": 6}], {"a": [15, 16], "b": np.array([0.9, 1.1])}),
    ...
    def testWithUpdatesFunctions(self):
        ...
        st_updated = st.with_updates(
            {"a": lambda x: x + 1, ("b", "d", "e"): lambda x: x + 7}, validate=True
        )
        # Updated values.
    ...
    def testWithUpdatesChecks(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"cannot create new sub-field.*\('b', 'c'\).*is not a "
            r"`StructuredTensor`",
        ):
        ...
        with self.assertRaisesRegex(
            ValueError, r"cannot update.*\('b', 'd', 'x'\).*does not already " r"exist"
        ):
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"does not allow both parent and child nodes.*"
    ...
    def testWithUpdatesDelete(self):
        ...
        with self.assertRaisesRegex(
            ValueError, r"cannot delete.*\('b', 'x'\).*not present"
        ):
            st.with_updates({("b", "x"): None}, validate=True)
        with self.assertRaisesRegex(ValueError, r"cannot delete.*\'x'.*not present"):
