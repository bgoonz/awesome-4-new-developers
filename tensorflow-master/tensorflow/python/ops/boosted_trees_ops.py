...
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_calculate_best_feature_split as calculate_best_feature_split,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_calculate_best_feature_split_v2 as calculate_best_feature_split_v2,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_calculate_best_gains_per_feature as calculate_best_gains_per_feature,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_center_bias as center_bias,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_create_quantile_stream_resource as create_quantile_stream_resource,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_example_debug_outputs as example_debug_outputs,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_make_quantile_summaries as make_quantile_summaries,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_make_stats_summary as make_stats_summary,
)
...
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_quantile_stream_resource_deserialize as quantile_resource_deserialize,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_quantile_stream_resource_flush as quantile_flush,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_quantile_stream_resource_get_bucket_boundaries as get_bucket_boundaries,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_quantile_stream_resource_handle_op as quantile_resource_handle_op,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_sparse_aggregate_stats,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_sparse_calculate_best_feature_split as sparse_calculate_best_feature_split,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_training_predict as training_predict,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_update_ensemble as update_ensemble,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
    boosted_trees_update_ensemble_v2 as update_ensemble_v2,
)
from tensorflow.python.ops.gen_boosted_trees_ops import (
...
class PruningMode(object):
    ...
    def from_str(cls, mode):
        if mode in cls._map:
            ...
            raise ValueError(
                "pruning_mode mode must be one of: {}".format(
                    ", ".join(sorted(cls._map))
                )
            )
...
class QuantileAccumulatorSaveable(saver.BaseSaverBuilder.SaveableObject):
    ...
    def __init__(self, resource_handle, create_op, num_streams, name):
        ...
        bucket_boundaries = get_bucket_boundaries(
            self._resource_handle, self._num_streams
        )
        slice_spec = ""
        specs = []
        ...
        super(QuantileAccumulatorSaveable, self).__init__(
            self._resource_handle, specs, name
        )
...
class QuantileAccumulator(tracking.TrackableResource):
  ...
  """
    ...
    def __init__(
        self, epsilon, num_streams, num_quantiles, name=None, max_elements=None
    ):
        self._eps = epsilon
        self._num_streams = num_streams
        ...
        resources.register_resource(
            self.resource_handle, self._init_op, is_initialized_op
        )
    ...
    def _initialize(self):
        return create_quantile_stream_resource(
            self.resource_handle, self._eps, self._num_streams
        )
...
class _TreeEnsembleSavable(saver.BaseSaverBuilder.SaveableObject):
    ...
    """
        stamp_token, serialized = gen_boosted_trees_ops.boosted_trees_serialize_ensemble(
            resource_handle
        )
        ...
        slice_spec = ""
        specs = [
            saver.BaseSaverBuilder.SaveSpec(stamp_token, slice_spec, name + "_stamp"),
            saver.BaseSaverBuilder.SaveSpec(
                serialized, slice_spec, name + "_serialized"
            ),
        ]
...
class TreeEnsemble(tracking.TrackableResource):
    ...
    def get_stamp_token(self):
        ...
        stamp_token, _, _, _, _ = gen_boosted_trees_ops.boosted_trees_get_ensemble_states(
            self.resource_handle
        )
        return stamp_token
    ...
    """
        ...
        return (
            array_ops.identity(stamp_token, name="stamp_token"),
            array_ops.identity(num_trees, name="num_trees"),
            array_ops.identity(num_finalized_trees, name="num_finalized_trees"),
            array_ops.identity(num_attempted_layers, name="num_attempted_layers"),
