...
class TransposeBenchmark(test.Benchmark):
    ...
    """
        ...
        with graph.as_default():
            ...
            with session_lib.Session(graph=graph) as session:
                ...
                print(
                    "%s %s inputshape:%s perm:%s %d %.6fsec, %.4fGB/s."
                    % (
                        device,
                        str(datatype),
    ...
    def benchmark_transpose(self):
        ...
        large_shapes = (
            [[2, 40, 40, 40, 32], [2, 40, 40, 40, 64]] * 2
            + [[2, 300, 300, 32], [2, 300, 300, 64]] * 2
            + [[2, 100000, 32], [2, 100000, 64]] * 2
        )
        large_perms = (
            [[0, 4, 1, 2, 3], [0, 2, 3, 4, 1]]
            + [[4, 1, 2, 3, 0]] * 2
        ...
        small_dim_large_shapes = [
            [2, 10000, 3],
            [2, 3, 10000],
            [2, 10000, 8],
            [2, 8, 10000],
        ]
        small_dim_small_shapes = [
            [2, 5000, 3],
            [2, 3, 5000],
            [2, 5000, 8],
            [2, 8, 5000],
