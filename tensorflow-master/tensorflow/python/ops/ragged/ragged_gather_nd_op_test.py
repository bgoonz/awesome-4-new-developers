...
class RaggedGatherNdOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                descr=(
                    "params: [B1, B2, B3], indices: [A1, (A2), 1], "
                    "result: [A1, (A2), B2, B3]"
                ),
                params=[[["a"]], [["b"]]],
                indices=ragged_factory_ops.constant_value([[[0]]], ragged_rank=1),
                expected=ragged_factory_ops.constant_value([[[[b"a"]]]], ragged_rank=1),
            ),
            # =========================================================================
            ...
            dict(
                descr=(
                    "params: [B1, (B2), (B3)], indices: [A1, 2], " "result: [A1, (B3)]"
                ),
                params=ragged_factory_ops.constant_value(
                    [[["a", "b", "c"], ["d"]], [["e", "f"]]]
                ),
            ...
            dict(
                descr=(
                    "params: [B1, (B2), (B3)], indices: [A1, A2, 2], "
                    "result: [A1, (A2), (B3)]"
                ),
                params=ragged_factory_ops.constant_value(
                    [[["a", "b", "c"], ["d"]], [["e", "f"]]]
            ...
            dict(
                descr=(
                    "params: [B1, (B2), B3], indices: [A1, A2, A3, 2], "
                    "result: [A1, A2, A3, B3]"
                ),
                params=ragged_factory_ops.constant_value(
                    [[["a", "b"], ["c", "d"]], [["e", "f"]]], ragged_rank=1
            ...
            # =========================================================================
            dict(
                descr=("params: [B1, (B2), (B3)], indices: [A1, 3], " "result: [A1]"),
                params=ragged_factory_ops.constant_value(
                    [[["a", "b", "c"], ["d"]], [["e", "f"]]]
                ),
            ...
            dict(
                descr=(
                    "params: [B1, (B2), (B3), B4], indices: [A1, 3], "
                    "result: [A1, B4]"
                ),
                params=ragged_factory_ops.constant_value(
    ...
    @parameterized.parameters(
        [
            dict(
                params=["a"], indices=0, error=(ValueError, errors.InvalidArgumentError)
            ),
            dict(
