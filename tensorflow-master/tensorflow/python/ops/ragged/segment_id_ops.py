  ...
  """
    with ops.name_scope(name, "RaggedSplitsToSegmentIds", [splits]) as name:
        splits = ops.convert_to_tensor(
            splits, name="splits", preferred_dtype=dtypes.int64
        )
  ...
  """
    ...
    with ops.name_scope(name, "SegmentIdsToRaggedSplits", [segment_ids]) as name:
        ...
        segment_ids = ragged_util.convert_to_int_tensor(
            segment_ids, "segment_ids", dtype=dtypes.int32
        )
        ...
        row_lengths = bincount_ops.bincount(
            segment_ids, minlength=num_segments, maxlength=num_segments, dtype=out_type
        )
