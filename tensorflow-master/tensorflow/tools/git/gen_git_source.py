...
parser = argparse.ArgumentParser(
    description="""Git hash injection into bazel.
...
parser.add_argument(
    "--debug", type=bool, help="print debugging information about paths", default=False
)
...
parser.add_argument(
    "--source_dir", type=str, help="Base path of the source code (used for cmake/make)"
)
