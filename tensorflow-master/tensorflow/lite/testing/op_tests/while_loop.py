...
def make_while_tests(options):
    ...
    test_parameters = [
        {"num_iterations": range(20), "increment_value": [[1]], "dtype": [tf.int32]},
        {"num_iterations": range(20), "increment_value": [["a"]], "dtype": [tf.string]},
    ]
    ...
    def build_graph(parameters):
        ...
        return (
            [num_iterations, increment_value],
            [counter, value, result_increment_value],
        )
    ...
    def build_inputs(parameters, sess, inputs, outputs):
        ...
        return (
            input_values,
            sess.run(outputs, feed_dict=dict(zip(inputs, input_values))),
        )
