...
class FreezeSavedModelTest(test_util.TensorFlowTestCase):
    ...
    def _convertSavedModel(
        ...
        graph_def, in_tensors, out_tensors, _ = convert_saved_model.freeze_saved_model(
    ...
    def testSimpleSavedModelWithInvalidSignatureKey(self):
        ...
        self.assertEqual(
            ...
            "Possible values are 'serving_default'.",
            str(error.exception),
        )
    ...
    def testMultipleMetaGraphDef(self):
        ...
        with session.Session(graph=ops.Graph()) as sess:
            ...
            predict_signature_def = saved_model.signature_def_utils.build_signature_def(
                sig_input_tensor_signature,
                sig_output_tensor_signature,
                saved_model.signature_constants.PREDICT_METHOD_NAME,
            )
            signature_def_map = {
                saved_model.signature_constants.DEFAULT_SERVING_SIGNATURE_DEF_KEY: predict_signature_def
            }
