...
class ConverterMetricsTest(test_util.TensorFlowTestCase):
    ...
    def _constructGraphDef(self):
        ...
        return convert_to_constants.convert_variables_to_constants_from_session_graph(
    ...
    def test_conversion_from_saved_model(self):
        ...
        converter = lite.TFLiteSavedModelConverter(
            saved_model_dir, set(["serve"]), ["serving_default"]
        )
...
class ConverterErrorMetricTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    def convert_and_check_location_info(
        self, converter, expected_type, expected_sources=None
    ):
    ...
    def test_failure_at_PrepareCompositeFunctionsPass(self):
        ...
        exported_error = metrics._gauge_conversion_errors.get_cell(
            "CONVERT_TF_TO_TFLITE_MODEL", "PrepareCompositeFunctionsPass", "", "UNKNOWN"
        ).value()
        self.assertEqual(
    ...
    def test_location_from_concrete_functions(self):
        ...
        self.convert_and_check_location_info(
            ...
            expected_sources=["tensorflow/lite/python/metrics_nonportable_test.py"],
        )
